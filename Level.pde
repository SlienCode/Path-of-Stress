class Level {
  ...
  Level(int year) {
    ...
    if (year == 1) {
      ...
      objects[0] = new Cone(4800, 0);
      objects[1] = new Bench(5500, 0);
      objects[2] = new Hydrant(4000, 0);
      objects[3] = new Car(850, 0);
      objects[4] = new Light(800, 0);
      objects[5] = new Sign(1400, 0);
      objects[6] = new Truck(1600, 0);
